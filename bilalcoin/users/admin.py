...
from bilalcoin.users.forms import UserChangeForm, UserCreationForm, UserProfileForm, UserVerifyForm
from bilalcoin.users.models import UserProfile, UserVerify, Testimonial
